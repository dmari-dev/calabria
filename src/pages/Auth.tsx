...
const Auth = () => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Account creato con successo! Benvenuto!");
      navigate("/onboarding");
    } catch (error: any) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Il tuo tour operator virtuale</p>
        </div>
        ...
        <Card className="shadow-elevated border-border/50">
          <CardHeader>
            ...
            <CardDescription>
              Inizia a creare i tuoi itinerari culturali personalizzati
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mb-4 p-3 bg-muted/50 rounded-lg border border-border/50">
              <p className="text-xs font-medium text-muted-foreground mb-2">Credenziali Utente Normale:</p>
              <div className="space-y-1 text-xs font-mono">
                <p><span className="text-muted-foreground">Email:</span> <span className="text-foreground">user@culture.it</span></p>
                <p><span className="text-muted-foreground">Password:</span> <span className="text-foreground">culture@1234</span></p>
              </div>
            </div>
