...
export const Header = () => {
  ...
  return (
    <>
      {/* Main Header - Nascosto allo scroll down */}
      <header 
      ...
      {/* Sticky Header Ridotto - Appare allo scroll down */}
      <header 
        className="fixed top-0 w-full transition-transform duration-300 ease-in-out shadow-lg" 
        style={{ 
          zIndex: 10000,
